public class Baston {
	public static void main(String[] args) {
		Worms worms1 = new Worms();
		Worms worms2 = new Worms();
		...
		while (worms1.isAlive() && worms2.isAlive()) {
			...
			if(worms2.getHp() < 1) {
				...
				System.out.println("le worms 1 à gagner, il lui reste "+ worms1.getHp() +"hp");
				break;
			}
			...
			if(worms1.getHp() < 1) {
				...
				worms1.setAlive(false);
				System.out.println("le worms 2 à gagner, il lui reste "+ worms2.getHp()+"hp");
				break;
			}
		}
	}
